...
import { CopyRegular, EditRegular, ShareRegular } from "@fluentui/react-icons";
                    ...
                    <Stack horizontal verticalAlign="center">
                        ...
                        <Stack horizontal verticalAlign="center">
                            <Link to="/" className={styles.headerTitleContainer}>
                                <h3 className={styles.headerTitle}>SuperCube</h3>
                            </Link>
                            <a href="/admin" className={styles.headerTitleButton}><EditRegular /></a>
                        </Stack>
